...
export default function SuggestionsForm({
  ...
  return (
    <>
      <h2 className="font-fredoka text-2xl text-center">
        Deixe sua sugestão de mensagem!
      </h2>
      <p className="max-w-[75%] sm:max-w-[50%] text-center">
        Se você tem uma sugestão de mensagem para um feriado nacional, preencha
        o formulário abaixo. Sua mensagem pode aparecer aqui com um
      ...
      <form id="form-message" className="flex flex-col gap-4">
        ...
        <button
          type="button"
          className="border border-emerald-500 bg-gray-50 px-4 py-2 font-bold text-emerald-500 transition-opacity hover:opacity-70 duration-300"
          onClick={async () => {
            await handlePost();
          }}
        >
